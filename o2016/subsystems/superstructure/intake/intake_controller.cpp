...
muan::units::Voltage IntakeController::Update(muan::units::Angle goal,
                                              muan::units::Angle sensor_input,
                                              bool index_click, bool enabled) {
  ...
  at_goal_ = (absolute_error(0, 0) < angle_tolerance_) &&
             (absolute_error(1, 0) < velocity_tolerance_);
...
void IntakeController::SetAngle(Angle theta) { observer_.x()(0, 0) = theta; }

bool IntakeController::AtGoal() const { return at_goal_; }
