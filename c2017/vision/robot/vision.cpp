...
VisionSubsystem::VisionSubsystem()
    : running_{false},
      ...
      action_{muan::actions::DrivetrainAction::PointTurn(
          1.0, true, properties_, c2017::QueueManager::GetInstance().drivetrain_goal_queue(),
          c2017::QueueManager::GetInstance().drivetrain_status_queue())} {}

void VisionSubsystem::Update() { action_.Update(); }
