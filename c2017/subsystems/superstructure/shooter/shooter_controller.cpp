...
ShooterController::ShooterController()
  ...
  controller_.u_min() = Eigen::Matrix<double, 1, 1>::Ones() * -std::numeric_limits<double>::infinity();
  controller_.u_max() = Eigen::Matrix<double, 1, 1>::Ones() * std::numeric_limits<double>::infinity();
  observer_ =
