...
using HatchIntakeOutputProto = muan::proto::StackProto<HatchIntakeOutput, 256>;
using HatchIntakeInputProto = muan::proto::StackProto<HatchIntakeInput, 256>;
using HatchIntakeStatusProto = muan::proto::StackProto<HatchIntakeStatus, 256>;
using HatchIntakeGoalProto = muan::proto::StackProto<HatchIntakeGoal, 256>;
