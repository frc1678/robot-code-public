...
import numpy
from third_party.frc971.control_loops.python import polytope
import third_party.frc971.control_loops.python.drivetrain
...
from third_party.frc971.control_loops.python.cim import CIM
...
class VelocityDrivetrainModel(control_loop.ControlLoop):
  def __init__(self, drivetrain_params, left_low=True, right_low=True,
    ...
    self._drivetrain = third_party.frc971.control_loops.python.drivetrain.Drivetrain(
