...
class LinearMotionProfile : public MotionProfile<DistanceU> {
 ...
 public:
  LinearMotionProfile(DistanceU distance, Time t) : distance_(distance), time_(t) {}
  LinearMotionProfile(DistanceU distance, VelocityU v) : distance_(distance), time_(distance / v) {}
