...
FileWriter::FileWriter(std::string base_path) { base_path_ = base_path; }
...
std::string FileWriter::GetBasePath() {
  std::vector<std::string> paths = {
      "/mnt/something/logs/",  // TODO(Wesley) find actual path being used on
                               // the roborio
      "/home/lvuser/logs/", "/home/wesley/logs/", "/logs", "/"};
